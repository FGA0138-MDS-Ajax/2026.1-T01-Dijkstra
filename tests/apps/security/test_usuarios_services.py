...
class UsuarioServiceAndRepositoryTestCase(TestCase):
    ...
    def test_fluxo_crud_completo_repository(self) -> None:
        ...
        # 2. Teste de Busca por ID existente e inexistente
